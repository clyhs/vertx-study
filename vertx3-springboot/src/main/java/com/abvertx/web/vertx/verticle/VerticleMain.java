package com.abvertx.web.vertx.verticle;
...
import com.abvertx.web.anno.RequestBody;
import com.abvertx.web.anno.RequestMapping;
import com.abvertx.web.base.SpringBootContext;
import com.abvertx.web.utils.VerticleUtils;
import com.abvertx.web.vertx.handler.TokenCheckHandler;
...
public class VerticleMain extends AbstractVerticle {
    ...
    public void start() throws Exception {
        ...
        server.requestHandler(router).listen(8080, handler -> {
            log.info("vertx run prot : [{}] run state : [{}]", 8080, handler.succeeded());
        });
    }
